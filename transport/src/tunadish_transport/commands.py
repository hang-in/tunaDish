...
from tunapi.core.commands import parse_command  # noqa: F401 — re-exported
from tunapi.engine_models import get_models, shorten_model
...
if TYPE_CHECKING:
    ...
    from tunapi.journal import Journal
...
def _register_project_in_config(
    ...
    *,
    ...
    try:
        from tunapi.config import HOME_CONFIG_PATH, read_config, write_config
